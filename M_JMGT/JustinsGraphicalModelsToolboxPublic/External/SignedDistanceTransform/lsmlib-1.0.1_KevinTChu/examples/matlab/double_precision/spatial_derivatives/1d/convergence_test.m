...
vel = (sin(pi*(x_low_res-0.25)));
vel = -(sin(pi*x_low_res)+2);
...
u_ENO1_RK3_low_res = zeros(N_with_ghostcells,1);
u_ENO2_RK3_low_res = zeros(N_with_ghostcells,1);
u_ENO3_RK3_low_res = zeros(N_with_ghostcells,1);
u_WENO5_RK3_low_res = zeros(N_with_ghostcells,1);

% initialize u
u_ENO1_RK3_low_res = sin(2*pi*x_low_res);
...
% set advection velocity function
vel = (sin(pi*(x_hi_res-0.25)));
vel = -(sin(pi*x_hi_res)+2);
...
% allocate memory for u 
u_ENO1_RK3_hi_res = zeros(N_with_ghostcells,1);
u_ENO2_RK3_hi_res = zeros(N_with_ghostcells,1);
u_ENO3_RK3_hi_res = zeros(N_with_ghostcells,1);
u_WENO5_RK3_hi_res = zeros(N_with_ghostcells,1);

% initialize u
u_ENO1_RK3_hi_res = sin(2*pi*x_hi_res);
