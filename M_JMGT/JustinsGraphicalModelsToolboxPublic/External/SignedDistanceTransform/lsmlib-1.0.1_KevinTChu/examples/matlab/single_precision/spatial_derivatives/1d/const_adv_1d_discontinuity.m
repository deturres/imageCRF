...
vel = single(v*ones(N_with_ghostcells,1));
...
% initialize u
u_ENO1_1d_RK1 = single(zeros(N_with_ghostcells,1));
...
% plot analytical positions of the discontinuities
pos1 = mod(v*t_f+1,2)-1;
pos2 = mod(mod(v*t_f,2)+1,2);
plot([pos1 pos1],[-0.1 1.1],'k');
plot([pos2 pos2],[-0.1 1.1],'k');
axis([-1 1 -0.1 1.1]);
