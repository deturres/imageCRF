  ...
  const string& object_name)
{
  ...
  // initialize d_velocity_never_computed to true to ensure that
  // the velocity is computed on the first call to computeVelocityField()
  ...
  const int component)
{
  ...
  // set d_velocity_never_computed to falsej
