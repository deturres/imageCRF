...
*/
   ...
   */
  LSMLIB_REAL area = LevelSetMethodToolbox<2>::computeVolumeOfRegionDefinedByZeroLevelSet(
    patch_hierarchy,
    phi_handle,
   ...
   */
  LSMLIB_REAL perimeter = LevelSetMethodToolbox<2>::computeVolumeOfZeroLevelSet(
    patch_hierarchy,
    phi_handle,
    grad_phi_plus_handle,
    control_volume_handle);
