 ...
 * to for a 3D problem to compute area and line integrals over regions
...
*/
   ...
   */
  LSMLIB_REAL volume_integral = 
    LevelSetMethodToolbox<3>::computeVolumeIntegral(
      patch_hierarchy,
      velocity_handle, 
      phi_handle,
   ...
   */
  LSMLIB_REAL surface_integral = 
    LevelSetMethodToolbox<3>::computeSurfaceIntegral(
      patch_hierarchy,
      velocity_handle, 
      phi_handle,
      grad_phi_plus_handle,
