/*
 * File:        computeExtensionFields3d.c
 ...
 *              compute extension fields for 3d level set functions
 */

/*===========================================================================
 *
 * computeExtensionFields3d() computes a distance from an 
 * arbitrary level set function using the Fast Marching Method.
 * 
 * Usage: [distance_function, extension_fields] = ...
 *        computeExtensionFields3d(phi, source_fields, dX
 *                                 mask, ...
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  for (i = 0; i < num_ext_fields; i++) {
#ifdef LSMLIB_DOUBLE_PRECISION
    tmp_mxArray = mxCreateNumericArray(3, grid_dims, 
                    mxDOUBLE_CLASS, mxREAL);
#else
    tmp_mxArray = mxCreateNumericArray(3, grid_dims, 
                    mxSINGLE_CLASS, mxREAL);
  ...
  error_code = computeExtensionFields3d(
                 distance_function,
                 extension_fields,
                 phi,
                 mask,
  ...
  if (error_code) {
    mexErrMsgTxt("computeExtensionFields3d failed...");
  }
