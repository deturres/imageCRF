/*
 * File:        UPWIND_HJ_ENO2_2D.c
 * Copyrights:  (c) 2005 The Trustees of Princeton University and Board of
 *                  Regents of the University of Texas.  All rights reserved.
 *              (c) 2009 Kevin T. Chu.  All rights reserved.
 * Revision:    $Revision: 149 $
 * Modified:    $Date: 2009-01-18 00:31:09 -0800 (Sun, 18 Jan 2009) $
 * Description: MATLAB MEX-file for 2d, second-order upwind HJ ENO 
 */

/*=======================================================================
 *
 * UPWIND_HJ_ENO2_2D() computes the second-order upwind HJ ENO
 * approximation to grad(phi)
 *
 * Usage: [phi_x, phi_y] = ...
 *        UPWIND_HJ_ENO2_2D(phi, vel_x, vel_y, ghostcell_width, dX)
 *
 * Arguments:
