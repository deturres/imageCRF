/* 
 * File:        test_find_line_in_tetrahedron_2.c
...
void checkCase(
  LSMLIB_REAL *x1, LSMLIB_REAL *x2, LSMLIB_REAL *x3, LSMLIB_REAL *x4, 
  LSMLIB_REAL *phi, LSMLIB_REAL *psi, 
  LSMLIB_REAL *point_on_line, LSMLIB_REAL *true_line_dir);
  ...
  LSMLIB_REAL *point_on_line, LSMLIB_REAL *true_line_dir)
{
  ...
  LSMLIB_REAL check_endpt1, check_endpt2;
  LSMLIB_REAL check_line_dir;
  int same_point;
  int err_code;
