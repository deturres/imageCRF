...
#define LSM3D_ADD_CONST_PRECOMPUTED_CURV_TERM_TO_LSE_RHS \
                                     lsm3daddconstprecomputedcurvtermtolserhs_					  
#define LSM3D_ADD_EXTERNAL_AND_NORMAL_VEL_TERM_TO_LSE_RHS \
                                  lsm3daddexternalandnormalveltermtolserhs_					  
 ...
 * of a mean curvature term to the right-hand side of the 
 * level set equation when it is written in the form:
 *   
 * \f[
 *   
 ...
 *                       of \f$ \phi \f$ 
 *  - b (in):            proportionality constant relating curvature
...
/*!
*
*  LSM3D_ADD_CONST_PRECOMPUTED_CURV_TERM_TO_LSE_RHS() adds the contribution of 
...
*/
 ...
 void LSM3D_ADD_CONST_PRECOMPUTED_CURV_TERM_TO_LSE_RHS(
  const LSMLIB_REAL *lse_rhs,
  ...
  const int *klo_rhs_fb,
  const int *khi_rhs_fb);
  
  
/*!
*
* LSM3D_ADD_EXTERNAL_AND_NORMAL_VEL_TERM_TO_LSE_RHS() adds the contribution of a normal 
...
void LSM3D_ADD_EXTERNAL_AND_NORMAL_VEL_TERM_TO_LSE_RHS(
  LSMLIB_REAL *lse_rhs,
  const int *ilo_rhs_gb, 
  const int *ihi_rhs_gb,
  const int *jlo_rhs_gb, 
