...
void GCoptimization::scramble_label_table()
{
   ...
   //srand(clock()); // (commented)changed by chetan on 16 April 2012
...
//    old_energy = -1;  //chetan - i really should have the oldEnergy < 0 condition-

    old_energy = new_energy + 1e10;  // chetan so adding this


//    while (old_energy < 0 || old_energy > new_energy  && curr_cycle <= max_num_iterations)  // chetan comment this
