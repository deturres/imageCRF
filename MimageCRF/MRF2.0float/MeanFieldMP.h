...
#ifndef __MEANFIELDMP_H__
#define __MEANFIELDMP_H__
...
#include "regions-new3.h"

#define FloatType float
#define FLOATTYPE float
class MeanFieldMP;

class MeanFieldMP : public MRF{
public:
	MeanFieldMP(int width, int height, int nLabels, EnergyFunction *eng);
	MeanFieldMP(int nPixels, int nLabels,EnergyFunction *eng);
	~MeanFieldMP();
  ...
  friend void getPsiMat(OneNodeClusterMF &cluster, FLOATTYPE *&destMatrix, 
...
protected:
	...
	void optimizeAlg_Old(int nIterations);
