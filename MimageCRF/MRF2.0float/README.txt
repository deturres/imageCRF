...
(c) If you are using the TRW-S software (provided by Vladimir Kolmogorov), you should cite
    [6] M. J. Wainwright, T. S. Jaakkola and A. S. Willsky.
        ...
        In IEEE Transactions on Information Theory, Vol. 51(11), pages 3697--3717, November 2005.
    [7] V. Kolmogorov.
        Convergent Tree-reweighted Message Passing for Energy Minimization.
        In IEEE Transactions on Pattern Analysis and Machine Intelligence (PAMI), vol. 28, no. 10, October 2006. 
...
The default type for energy is int. If you want to change this type to other numerical
