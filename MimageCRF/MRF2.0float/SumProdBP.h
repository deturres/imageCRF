#ifndef __SUMPRODBP_H__
#define __SUMPRODBP_H__
...
class SumProdBP : public MRF{
public:
	SumProdBP(int width, int height, int nLabels, EnergyFunction *eng);
	SumProdBP(int nPixels, int nLabels,EnergyFunction *eng);
	~SumProdBP();
  ...
  friend void getPsiMat(OneNodeClusterMarg &cluster, FLOATTYPE *&destMatrix, 
